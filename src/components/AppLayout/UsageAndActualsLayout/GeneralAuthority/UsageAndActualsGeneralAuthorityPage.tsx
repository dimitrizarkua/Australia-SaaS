...
class UsageAndActualsGeneralAuthorityPage extends React.PureComponent<IProps> {
  ...
  public renderContentPage() {
    return <PageContent>UsageAndActualsGeneralAuthorityPage</PageContent>;
  }
...
)(UsageAndActualsGeneralAuthorityPage);
