...
class UsageAndActualsJobContractPage extends React.PureComponent<IProps> {
  ...
  public renderContentPage() {
    return <PageContent>UsageAndActualsJobContractPage</PageContent>;
  }
...
)(UsageAndActualsJobContractPage);
